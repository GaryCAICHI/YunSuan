...
class newVIMac64bMod extends Module {
  ...
  val stage1 = Module(new newVIMac64bStage1())
  val stage2 = Module(new newVIMac64bStage2())
  val stage3 = Module(new newVIMac64bStage3())
...
object newVIMac64bMod extends App {
  (new ChiselStage).execute(args, Seq(
    ChiselGeneratorAnnotation(() => new newVIMac64bMod()), FirtoolOption("--lowering-options=explicitBitcast")
  ))
}